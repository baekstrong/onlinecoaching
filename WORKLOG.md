...
- 라이브 의존(이메일·삭제·스케줄)은 키/cron 준비 후. 테스트는 no-op·주입 mock으로 로직 검증.
- 변경된 파일: docs/superpowers/plans/2026-06-15-phase4-viewing-notification-retention.md
- 다음 작업: 4단계 Task 1부터 서브에이전트 구동 실행
